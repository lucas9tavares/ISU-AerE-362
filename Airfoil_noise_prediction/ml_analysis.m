...
% Split data into training (85%) and test sets (15%)
...
net = feedforwardnet([5, 10, 10]);  % Using three layers with 5, 10, and 10 neurons respectively
...
% net.trainFcn = 'traingdx'; %	Use Variable Learning Rate Gradient Descent

net.trainParam.epochs = 300;  % Set the number of epochs
...
saveas(gcf, 'Scatter_Actual_vs_Predicted.png');